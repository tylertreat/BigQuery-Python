import unittest
from bigquery.schema_builder import schema_from_record,describe_field,bigquery_type
...
class TestBigQueryTypes(unittest.TestCase):
    ...
    def test_unicode_is_string(self):
        self.assertItemsEqual(bigquery_type(u"Here is a happy face \u263A"),'string')
    ...
    def test_isoformat_timestring(self):
        self.assertItemsEqual(bigquery_type(datetime.now().isoformat()),'timestamp')
    ...
    def test_timestring_thu_1_july_2004_22_30_00(self):
        self.assertItemsEqual(bigquery_type("Thu, 1 July 2004 22:30:00"),'timestamp')
    ...
    def test_timestring_arbitrary_fn_success(self):
        self.assertItemsEqual(bigquery_type("whatever",timestamp_parser=lambda x:True),'timestamp')

    def test_timestring_arbitrary_fn_fail(self):
        self.assertItemsEqual(bigquery_type("February 20th 1973",timestamp_parser=lambda x:False),'string')
